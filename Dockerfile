...
RUN mkdir /opt/wine-stable/share/wine/mono && wget -O - https://dl.winehq.org/wine/wine-mono/5.0.0/wine-mono-5.0.0-x86.tar.xz |tar -cfJ -C /opt/wine-stable/share/wine/mono 
